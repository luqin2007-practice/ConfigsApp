...
namespace Configs.widget
{
    ...
    {
        public static readonly DependencyProperty TextsProperty = DependencyProperty.Register(nameof(Texts), typeof(IEnumerable<LabelText>), typeof(Labels), new PropertyMetadata(new List<LabelText>()));

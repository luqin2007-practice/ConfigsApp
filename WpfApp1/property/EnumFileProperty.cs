...
{
    public class EnumFileProperty(ConfigFile file, ConfigProperty property) : EnumProperty(property.Property,
        property.Name, property.Desc, (EnumType)property.Type, property.Default.GetValue<EnumValue>())
    {

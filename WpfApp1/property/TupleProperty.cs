...
/// <summary>
/// 布尔值类型属性，可以接受是、否和第三种状态输入（表现为 null）
/// </summary>
/// <param name="propertyName">属性名</param>
/// <param name="title">属性显示名</param>
/// <param name="description">属性描述</param>
public abstract class TupleProperty(string propertyName, string title, string description)
    : Property(propertyName, title, description)
{
    ...
    public override object? InputValue => _value!.IsChecked;
